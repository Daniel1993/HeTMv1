...
plot \
     ...
     sprintf("%s/CPUonly_rand_sep_DISABLED_large_w100.avg", ARG1) using 45:18 notitle with linespoints linecolor rgbcolor "#13FF03" dashtype '-' pt 6 lw 1 ps 0.8, \
     sprintf("%s/GPUonly_rand_sep_DISABLED_large_w100.avg", ARG1) using 45:18 notitle with linespoints linecolor rgbcolor "#13C3C3" dashtype '-' pt 4 lw 1 ps 0.8, \
