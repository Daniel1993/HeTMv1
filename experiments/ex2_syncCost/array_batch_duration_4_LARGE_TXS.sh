...
make clean ; make CMP_TYPE=COMPRESSED DISABLE_RS=1 USE_TSX_IMPL=1 CPUEn=0 PR_MAX_RWSET_SIZE=50 \
	BANK_PART=10 BANK_INTRA_CONFL=0.0 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14 \
	BMAP_GRAN_BITS=13 BANK_PART_SCALE=10 >/dev/null
### 90% writes
doRunLargeDTST GPUonly_rand_sep_DISABLED_large

make clean ; make CMP_TYPE=COMPRESSED DISABLE_RS=1 USE_TSX_IMPL=1 CPUEn=0 PR_MAX_RWSET_SIZE=50 \
	BANK_PART=10 BANK_INTRA_CONFL=0.0 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14 \
	BMAP_GRAN_BITS=13 OVERLAP_CPY_BACK=1 BANK_PART_SCALE=10 >/dev/null
### 90% writes
doRunLargeDTST GPUonly_rand_sep_DISABLED_OVERLAP_large
...
make clean ; make CMP_TYPE=COMPRESSED DISABLE_RS=1 USE_TSX_IMPL=1 CPUEn=0 PR_MAX_RWSET_SIZE=500 \
	BANK_PART=10 BANK_INTRA_CONFL=0.0 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14 \
	BMAP_GRAN_BITS=13 BANK_PART_SCALE=50 >/dev/null
### 90% writes
doRunLargeDTST GPUonly_rand_sep_DISABLED_large

make clean ; make CMP_TYPE=COMPRESSED DISABLE_RS=1 USE_TSX_IMPL=1 CPUEn=0 PR_MAX_RWSET_SIZE=500 \
	BANK_PART=10 BANK_INTRA_CONFL=0.0 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14 \
	BMAP_GRAN_BITS=13 OVERLAP_CPY_BACK=1 BANK_PART_SCALE=50 >/dev/null
### 90% writes
doRunLargeDTST GPUonly_rand_sep_DISABLED_OVERLAP_large
